...
def get_config_original(outfile):
    ...
    config.stride = 1
    config.clearcolor = readdyviewer.Color(0. / 255., 0. / 255., 0. / 255.)#readdyviewer.Color(253. / 255., 246. / 255., 227. / 255.)
    return config
...
def get_config_rgb_light_gray(outfile):
    ...
    config.radii[p_types['Activator_predator']] = .4
    config.stride = 1
    config.clearcolor = readdyviewer.Color(240. / 255., 240. / 255., 240. / 255.)#readdyviewer.Color(253. / 255., 246. / 255., 227. / 255.)
    return config
...
def get_config_solarized_light(outfile):
    ...
    config.radii[p_types['Activator_predator']] = .4
    config.stride = 1
    config.clearcolor = readdyviewer.Color(227. / 255., 227. / 255., 227. / 255.)#readdyviewer.Color(253. / 255., 246. / 255., 227. / 255.)
    return config
